...
from transformation_test_utils import is_transformation_linear
...
def test_is_rotate_z_linear(u, v, s):
    is_transformation_linear(rotate_z_by(0.5), u, v, s)
...
def test_is_translate_linear(u, v, s):
    ...
    is_transformation_linear(translate_by(i), u, v, s)
    is_transformation_linear(translate_by(j), u, v, s)
    is_transformation_linear(translate_by(k), u, v, s)
